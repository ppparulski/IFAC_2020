...
The results are depicted in Fig.~\ref{fig:re_pendu_th1th2_case_1} for Case~I and  Fig.~\ref{fig:re_pendu_th1th2_case_2} for second case.
%
...
Fig.~\ref{fig:re_pendu_mianownik_case_1} and Fig.~\ref{fig:re_pendu_mianownik_case_2} depicts a plot of $L_g L_f^2 h$ during one exemplary simulation trial, for Case I and II, respectively.
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.85\linewidth]{img/M_d_bez_sat}
	\caption{Decoupling matrix -- Case I }
	\label{fig:re_pendu_mianownik_case_1}
\end{figure}
% 
%
\begin{figure}[!h]
...
The common exemplary successful initial condition (for Case I and II) was chosen as {\color{red} $\theta_{1_0} = 120^\circ$ and $\theta_{2_0} = -15^\circ$}.
%
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.85\linewidth]{img/pendubot_th1th2_sat}
...
%
Figure~\ref{fig:re_pendu_reakcja_case_1} and Fig.~\ref{fig:re_pendu_reakcja_case_2} depict the motor's torque expended during stabilization process for exemplary initial conditions.
...
\label{fig:re_pendu_reakcja_case_1}
\end{figure}
%
%
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{img/Fr_sat}
...
Figure \ref{fig:re_pendu_tau_bez_sat} depict the motor's torque expended during stabilization process for exemplary initial conditions.
%
%
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\linewidth]{img/tau_bez_sat}
\caption{Motor torque -- Case I}
\label{fig:re_pendu_tau_bez_sat}
\end{figure}
%
%
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\linewidth]{img/tau_sat}
	\caption{Motor torque -- Case II}
	\label{fig:re_pendu_tau_sat}
\end{figure}
%
...
The drawings depicting the total torque consumption during simulation are presented in Fig.~\ref{fig:re_pendu_tau_total_bez_sat}.
%}
%
\begin{figure}[!ht]
\centering
