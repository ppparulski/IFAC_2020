...
\\
Then the convergence area  for the linear controller in the following form
%
\begin{equation}
u_{lin} = -K (x_r - x),
...
\end{equation}
%
which stabilizes the robot in the equilibrium pose 
{\color{orange} !!!!!!!Not here! HERE ONLY general statements. Results in Section 4}
(Fig.~\ref{fig:obszar_zbierznosci_tylko_liniowy}) should be determined.
%
\begin{figure}[!ht]
	\centering
