...
\\
{\color{blue}tutaj jakieœ ³adne wzorki opisujace te prze³¹czenie...}
{\color{orange} !!!!!!!Not here! HERE ONLY general statements. Results in Section 4}
\\
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.85\linewidth]{img/RE_pendu_wykres_zbieznosci_bez_sat_lqr}
	\caption{A~region of initial conditions that leads to upright position for linear controller.}
	\label{fig:obszar_zbierznosci_tylko_liniowy}
\end{figure}
%
...
%	\caption{A~region of initial conditions (Fig.~\ref{fig:LQR_tunel_warunki}) that leads to upright position, for linear controller.}
